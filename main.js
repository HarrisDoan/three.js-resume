...
const geometry1 = new THREE.TorusGeometry(10, 1, 16, 100);
...
const geometry3 = new THREE.TorusGeometry(10, 1, 16, 100);
...
const fujiTexture = new THREE.TextureLoader().load('fuji.jpg');
scene.background = fujiTexture;
